...
def spatial_O(df_index, leakage):
    ...
    # spatial
    last_2_frames_N, _, current_R, current_N, g_rates, s_list, abundances, t_list, biomass  = update.simulate_3D_NBC(5, fR, gr, R_space_ig, N0_space, biomass, param, mat_F)
